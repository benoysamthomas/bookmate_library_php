...
<?php $this->load->view('bookmate_include/head');?>
	<body class="is-preload">
		...
		?>
				...
				<!-- Main -->
							<div id="main">
							<?php if(count($book_search_info) != 0){foreach($book_search_info as $b){?>
						<div class="inner">
						<?php if($count==1){?>
							<h1>Book Search Details <span class="pull-right"></span></h1>
								<p class="text-left"><a href="<?php echo base_url(); ?>">Home &nbsp;</a>> Book Search Details for "<?php echo $book_search_name?>"</p>
						<?php }
						$count++;
						?>
						...
						<div class="container-fluid">
								<div class="row">
									<div class="col-md-5">
							<h3> No Book Found for the search Result</h3>
